...
```
```
python train.py -c configs/datasets/cifar10.yml --model grassmanian_vit_2_4_32 --gpu 0    /home/papastrat/Desktop/ilias/Compact-Transformers/data/cifar-10-python/cifar-10-batches-py/
```
## ViT
...
```
python train.py -c configs/datasets/cifar10.yml --model img_riem_vit_6_4_32 --gpu 0 --log-wandb ./data/CIFAR-10-images-master/
```
Riemmanian Vit
