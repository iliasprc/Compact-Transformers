...
class Attention_Euc_SPD(nn.Module):
...
class Manifold_PyramidVisionTransformerV2(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes=1000, embed_dims=[64, 128, 256, 512],
                 num_heads=[1, 2, 4, 8], mlp_ratios=[4, 4, 4, 4], qkv_bias=False, qk_scale=None, drop_rate=0.,
                 attn_drop_rate=0., drop_path_rate=0., norm_layer=nn.LayerNorm,
                 depths=[3, 4, 6, 3], sr_ratios=[8, 4, 2, 1], num_stages=4, linear=False,*args, **kwargs):
        super().__init__()
...
@register_model
def manifold_pvt_v2_b1(pretrained=False, **kwargs):
    model = Manifold_PyramidVisionTransformerV2(
...
@register_model
def manifold_pvt_v2_b2(pretrained=False, **kwargs):
    model = Manifold_PyramidVisionTransformerV2(
        patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[8, 8, 4, 4], qkv_bias=True,
...
@register_model
def manifold_pvt_v2_b3(pretrained=False, **kwargs):
    model = Manifold_PyramidVisionTransformerV2(
        patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[8, 8, 4, 4], qkv_bias=True,
...
@register_model
def manifold_pvt_v2_b4(pretrained=False, **kwargs):
    model = Manifold_PyramidVisionTransformerV2(
        patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[8, 8, 4, 4], qkv_bias=True,
...
@register_model
def manifold_pvt_v2_b5(pretrained=False, **kwargs):
    model = Manifold_PyramidVisionTransformerV2(
...
@register_model
def manifold_pvt_v2_b2_li(pretrained=False, **kwargs):
    model = Manifold_PyramidVisionTransformerV2(
        patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[8, 8, 4, 4], qkv_bias=True,
