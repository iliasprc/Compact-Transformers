...
class Block(nn.Module):
    ...
    def __init__(self, dim, num_heads, mlp_ratio=4., qkv_bias=False, drop=0., attn_drop=0.,
        ...
        self.attn = EuclideanRiemmanianAtt(dim, num_heads=num_heads, qkv_bias=qkv_bias, attention_dropout=attn_drop, projection_dropout=drop)
...
class PoolingVisionTransformer(nn.Module):
    ...
    def __init__(self, img_size, patch_size, stride, base_dims, depth, heads,
                 ...
                 attn_drop_rate=.0, drop_rate=.0, drop_path_rate=.0,attention_type='all'):
